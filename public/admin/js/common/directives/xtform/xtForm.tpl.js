...
( function () {
        ...
        return {
            ...
            link: function ( scope, element, attrs, ctrls ) {
                ...
                function getErrorMessageForKey( key ) {
                    ...
                    return attrs[ attrKey ] ? attrs[ attrKey ] : $interpolate( defaultErrors[ key ] )( attrs );
                }
                /**
    ...
    xtForm.directive( 'xtForm', [ "$timeout", function ( $timeout ) {
        'use strict';
        return {
            require: '',
            priority: -1,
        ...
        var vm = this,
            ...
            validationStrategy = $attrs.strategy ? xtFormConfig.getValidationStrategy( $attrs.strategy ) : xtFormConfig.getDefaultValidationStrategy();
        ...
        return {
            ...
            link: function ( scope, element, attrs ) {
                ...
                function toggleAriaAttributes( showErrors ) {
                    if ( showErrors ) {
                        inputEl.attr( 'aria-invalid', true ).attr( 'aria-describedby', attrs.id );
                    } else {
        ...
        return {
            ...
            link: function ( scope, element, attrs, xtForm ) {
                ...
                function setupNgModel() {
                    ...
                    ngModelElement = ngModelElementId ? angular.element( document.getElementById( ngModelElementId ) ) : element;
                ...
                function redrawErrors() {
                    ...
                    var noOfErrors = attrs.multiple ? ngModel.$xtErrors.length : 1;
                    var errors = ngModel.$xtErrors.slice( 0, noOfErrors ).map( function ( value ) {
                    ...
                    if ( errors !== lastErrors ) {
                        lastErrors = errors;
                        setTimeout( function () {
                            element.attr( 'title', errors ).tooltip( 'fixTitle' ).tooltip( 'show' );
                        } );
                    }
                }
