var gulp = require('gulp'),
    ...
    dotenv = require('dotenv').config({path: '../api/.env'}),
    environment,
...
gulp.task('build', function (callback) {
    runSequence('clean:dist',
        'jshint',
        ['js:vendor', 'js:templates', 'css', 'fonts', 'images', 'favicons', 'svg'],
        'js:files',
        'html',
        'htaccess',
        callback);
...
gulp.task('clean:dist', function () {
    ...
    del.sync([
        config.paths.output + '**/*'
        // '!' + config.paths.output + '/assets',
        // '!' + config.paths.output + '/assets/images',
        // '!' + config.paths.output + '/assets/images/customers',
        // '!' + config.paths.output + '/assets/images/customers/**',
        // '!' + config.paths.output + '/assets/images/customers/**/*',
...
gulp.task('html', function () {
    ...
    if (condition) {
        ...
        inputs = [
            'http://localhost:4010/livereload.js',
